...
const PageSeries = () => {
        ...
        const fetchMovies = async () => {
            try {
                ...
                let params = { 
                    userId: user?.userId, 
                    type: true, 
                    page: page, // Sử dụng page bắt đầu từ 1
                    pageSize: pageSize 
                };
                ...
                // Nếu page = 1 thì set mới, nếu không thì thêm vào danh sách cũ
    ...
    const handleLoadMore = () => {
        setPage(prev => prev + 1); // Tăng page từ 1 lên 2, 3,...
    };

    // Reset page khi đổi category
    useEffect(() => {
        setPage(1); // Reset về page 1 khi đổi category
        setMovies([]); // Reset danh sách phim khi đổi category
    }, [selectedCategory]);
